...
export class Migration1680602453613 implements MigrationInterface {
  name = 'Migration1680602453613';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`product\` (\`id\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`productName\` varchar(255) NULL, \`productPrice\` int NOT NULL DEFAULT '0', \`productDescription\` varchar(400) NULL, \`productCategory\` varchar(255) NULL, \`productCookingTime\` int NULL, \`productFavoritesCounter\` int NOT NULL DEFAULT '0', \`pictureId\` varchar(36) NULL, UNIQUE INDEX \`REL_70f1dbdc3ac63d475ae8918836\` (\`pictureId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
